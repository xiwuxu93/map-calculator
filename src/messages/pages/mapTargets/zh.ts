  ...
  schema: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "应以脑灌注压（CPP）= MAP − ICP 为直接目标。多数路径建议 CPP 60–70 mmHg，所需 MAP 约 80–110，取决于 ICP 与自调节情况。",
      },
      {
        question: "心脏骤停复苏后应维持怎样的 MAP？",
        answer:
          "多数流程以 MAP ≥65–75 mmHg 为起点，再结合神经功能、合并症与器官功能做个体化调整，避免早期低灌注。",
      },
      {
        question: "缺血性卒中应维持怎样的 MAP？",
        answer:
          "急性期常采取允许性高血压以维持半暗带灌注，可在指南范围内容忍较高 MAP；具体目标应遵循卒中指南与神经科意见。",
      },
      {
        question: "何时应使用动脉置管监测 MAP？",
        answer:
          "使用血管活性药物的休克、血流动力学快速波动、重度低血压或需按 CPP 精准靶向的神经病例，宜优先考虑动脉置管。",
      },
    ],
  },
  t0001: "面向临床的实用指南",
