...
const contextCards = [
  {
    ...
    items: [
      { label: 'MAP <65 mmHg:', body: 'Typically requires intervention (fluids/pressors)' },
      { label: 'MAP 65-80 mmHg:', body: 'Target range for most ICU patients' },
      { label: 'MAP >100 mmHg:', body: 'Evaluate for hypertension or excessive vasopressor dosing' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'MAP 60-70 mmHg:', body: 'Monitor trends and perfusion markers' },
      { label: 'MAP >130 mmHg:', body: 'Consider hypertensive emergency evaluation' },
    ],
  },
  {
    heading: 'Operating Room',
    items: [
      { label: 'MAP <65 mmHg:', body: 'Assess depth of anesthesia or hypovolemia' },
      { label: 'MAP 65-100 mmHg:', body: 'Typical intraoperative target range' },
      { label: 'MAP >100 mmHg:', body: 'Evaluate for inadequate anesthesia or pain' },
    ],
  },
  {
    heading: 'Post-Operative Care',
    items: [
      { label: 'MAP trending down:', body: 'Possible bleeding or third-spacing' },
...
const measurementErrors = [
  { error: 'Cuff too small', bpEffect: 'Falsely elevated', mapEffect: 'MAP falsely elevated' },
  { error: 'Arm below heart level', bpEffect: 'Falsely elevated', mapEffect: 'MAP falsely elevated' },
  { error: 'Arm above heart level', bpEffect: 'Falsely low', mapEffect: 'MAP falsely low' },
  { error: 'Back unsupported', bpEffect: 'Elevated DBP', mapEffect: 'MAP increases 2-5 mmHg' },
  { error: 'Talking during measurement', bpEffect: 'Falsely elevated', mapEffect: 'MAP elevated 5-10 mmHg' },
  { error: 'Full bladder', bpEffect: '+10-15 mmHg', mapEffect: 'MAP increases 5-7 mmHg' },
  { error: 'Recent caffeine/tobacco', bpEffect: 'Falsely elevated', mapEffect: 'MAP elevated 5-8 mmHg' },
] as const;
...
const calculatorResources = [
  ...
  },
  {
    ...
    description: '— Nursing-focused reference launching in Week 4.',
  ...
  sections: {
    ...
    bpToMap: {
      ...
      alternative: {
        ...
        intro: 'Arterial lines output MAP directly, but clinicians often verify calculations mentally:',
