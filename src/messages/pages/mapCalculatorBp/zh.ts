...
const mapCalculatorBpZh: MapCalculatorBpContent = {
    ...
    "faq": [
      {
        ...
        "answer": "使用心算技巧：MAP ≈ 舒张压 +（脉压 ÷ 3）。以 120/80 为例，脉压为 40，除以 3（≈13）后加到舒张压（80 + 13 = 93 mmHg）。"
      },
      {
        "question": "MAP 比血压更重要吗？",
        "answer": "两者回答的临床问题不同。MAP 反映器官灌注压，而收缩压 / 舒张压用于高血压诊断与心脏负荷评估。在重症场景中，MAP 往往是优先指标。"
      },
      {
        "question": "自动血压计的读数能直接用于 MAP 计算吗？",
        "answer": "可以。大多数示波式血压计精度可靠，有些设备会直接显示 MAP。若设备没有显示，可将收缩压与舒张压输入此计算器获取 MAP 与解读。"
      },
      {
        "question": "脓毒症管理时该看 MAP 还是收缩压？",
        "answer": "以 MAP 为准。《生存脓毒症运动》指南建议维持 MAP ≥65 mmHg，因为它比单看收缩压更能反映器官灌注。"
      },
      {
        "question": "如果换算出的 MAP 与临床表现不符怎么办？",
        "answer": "先确认血压测量是否准确，再核对输入数值。如结果与病情不符，可重新手动测量；若仍存在差异，考虑置入动脉导管。"
      },
      {
        "question": "不同人群的 MAP 目标是否不同？",
        "answer": "是的。长期高血压的老年人通常需要 MAP 70-85 mmHg；年轻成年患者多能耐受 60-65 mmHg；创伤性脑损伤常要求 80-110 mmHg；卒中流程可能采用宽容性高血压。"
      }
    ],
    "breadcrumbs": {
      "home": "首页",
  ...
  "hero": {
    ...
    "snapshotItems": [
      {
        "label": "主要用途",
        "value": "快速将血压换算为 MAP，并提供可执行的解读"
      },
      {
        "label": "适用场景",
        "value": "ICU 查房、脓毒症流程、围术期监测"
      },
      {
        "label": "得出结果所需时间",
        "value": "数秒——快速选择常见血压组合"
  ...
  "sections": {
    "whyCalculate": {
      ...
      "intro": "血压是医疗机构记录最频繁的生命体征。诊室与床旁监护仪会自动呈现收缩压与舒张压，但这些数值只代表每个心动周期的高峰与低谷。平均动脉压（MAP）则把这些读数转化为真正推动器官灌注的平均灌注压力。",
      "clinicalReality": {
        "heading": "临床现实",
    ...
    "bpToMap": {
      ...
      "formulaExplanation": "心脏在每个心动周期中约有三分之一的时间处于收缩期，三分之二处于舒张期。由于舒张期持续时间更长，舒张压在平均动脉压计算中占比更大，公式正是对这一生理比例的体现。",
      ...
      "contextCards": [
        {
          ...
          "items": [
            ...
            {
              "label": "MAP 65-80 mmHg：",
              "body": "多数 ICU 患者的目标范围"
            },
            {
              "label": "MAP >100 mmHg：",
              "body": "评估是否存在高血压或升压药剂量过高"
            }
          ]
        },
        {
